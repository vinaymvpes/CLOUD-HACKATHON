...
user = 'mongouser'           # username as set for the mongodb admin server (the username used in secret.yaml - before base64 conversion)
password = 'mongopassword'       # password as set for the mongodb admin server (the password used in secret.yaml - before base64 conversion)
host = 'mongo-service'    # service name of the mongodb admin server as set in the service for mongodb server
